/* oxlint-disable import/no-unassigned-import -- vendored from Drawnix; the stylesheet import is a side effect */
  ...
  return (
    ...
    >
      <div
        ...
        // vendor patch: overflow lives in styles/index.scss so `.disabled-scroll` can override it;
        // an inline `overflow: auto` here beats that rule and disabledScrollOnNonFocus never applies
